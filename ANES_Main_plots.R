...
tidy_ideo <- tidy(m_ideo, effects = "fixed", conf.int = TRUE)
tidy_trad <- tidy(m_trad, effects = "fixed", conf.int = TRUE)
tidy_operational <- tidy(m_operational, effects = "fixed", conf.int = TRUE)

tidy_ideo_noint <- tidy(m_ideo_no_int, effects = "fixed", conf.int = TRUE)
tidy_trad_noint <- tidy(m_trad_no_int, effects = "fixed", conf.int = TRUE)
tidy_op_noint <- tidy(m_operational_no_int, effects = "fixed", conf.int = TRUE)
